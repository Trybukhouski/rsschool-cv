...
The main tools I use in development are JS, HTML, CSS, React, Webpack, Sass
...
## EDUCATION
---
* __EPAM UPSkill Lab__, Student (Front-end)
_October 2020 - December 2020_
* __RS-School__, Student (Front-end)
_November 2020 - Present_
...
* __Development tools:__ VSCode, Git, Webpack
